							...
							<form method='post' action='{{ route("register") }}'>@csrf
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="text" class="form-control border-0 bg-light rounded-end ps-1" name='name' placeholder="Name" id="name">
									</div>
								</div>
                                ...
                                <div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="number" class="form-control border-0 bg-light rounded-end ps-1" name='phone' placeholder="Phone" id="phone">
									</div>
								</div>
                                ...
                                <div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="email" class="form-control border-0 bg-light rounded-end ps-1" name='email' placeholder="E-mail" id="email">
									</div>
								</div>
								<!-- Password -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="password" name='password' class="form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="password">
									</div>
								</div>
								<!-- Confirm Password -->
								<div class="mb-4">
